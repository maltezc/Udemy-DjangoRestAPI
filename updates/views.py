...
class SerializedDetailView(View):
   def get(self, request, *args, **kwargs):
        ...
        data = serialize("json", [obj,], fields=('user', 'content')) #fields will filter to only show those instead of all fields.
        json_data = data
...
class SerializedListView(View):
   def get(self, request, *args, **kwargs):
        ...
        data = serialize("json", qs, fields=('user', 'content')) #fields will filter to only show those instead of all fields.
        print(data)
        json_data = data
        # data = {
        #     "user": obj.user.username,
